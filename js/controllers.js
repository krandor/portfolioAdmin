...
app.controller('DashboardController', function($scope) {
  $scope.user = new User({
    ...
    downloads: [{project:{name: "Highlander", description:"In-house-built CRM system"}, downloadCount:3},
                ...
                {project:{name:"Eve-Online Wormhole Ops", description:"Tool to calculate monitary distribution of wormhole operations for the MMORPG 'Eve-Online'."}, downloadCount: 4}],
    saves: 2,
    projects: [
      ...
      {name:"Eve-Online Wormhole Ops", description:"Tool to calculate monitary distribution of wormhole operations for the MMORPG 'Eve-Online'."}
    ]
  });
